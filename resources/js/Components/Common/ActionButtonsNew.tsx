        ...
        <div className={`flex flex-col sm:flex-row gap-3 sm:gap-4 ${className}`}>
            ...
            {showQuickOrder && (
                <button
                    ...
                    disabled={!inStock}
                    className={`flex-1 font-medium py-3 px-6 rounded-lg transition-colors bg-blue-600 hover:bg-blue-700 text-white ${!inStock ? 'opacity-50 cursor-not-allowed bg-gray-400' : ''}`}
                >
                    اطلب الآن
                </button>
            )}
