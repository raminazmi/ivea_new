                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {cartItems.length === 0 ? (
                        <div className="text-center py-8 md:py-12">
                            ...
                            <Link
                                href="/products"
                                className="bg-indigo-600 hover:bg-indigo-700 text-white py-2.5 md:py-3 px-4 md:px-6 rounded-lg inline-flex items-center text-sm md:text-base"
                            >
                                تصفح المنتجات
                            </Link>
                        </div>
                                ...
                                <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
                                    ...
                                    <div className="space-y-3 md:space-y-4">
                                        <button
                                            ...
                                            className="w-full bg-green-600 hover:bg-green-700 text-white py-2.5 md:py-3 px-4 md:px-6 rounded-lg font-medium text-sm md:text-base transition-colors"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="w-full bg-red-600 hover:bg-red-700 text-white py-2.5 md:py-3 px-4 md:px-6 rounded-lg font-medium text-sm md:text-base transition-colors"
                                        >
                                            تفريغ السلة
                                        </button>
                                        ...
                                        <Link
                                            href="/products"
                                            className="w-full bg-gray-600 hover:bg-gray-700 text-white py-2.5 md:py-3 px-4 md:px-6 rounded-lg font-medium text-sm md:text-base transition-colors inline-block text-center"
                                        >
