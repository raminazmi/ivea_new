        ...
        <>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                ...
                <div className="relative flex min-h-screen flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                    <div className="relative w-full max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                        <header className="grid grid-cols-2 items-center gap-2 py-8 md:py-10 lg:grid-cols-3">
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                {auth.user ? (
                                    <Link
                                        ...
                                        className="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white text-sm md:text-base"
                                    >
                                        Dashboard
                                    </Link>
                                ) : (
                                ...
                                >
                                    ...
                                    <div className="relative flex items-center gap-6 lg:items-end">
                                        <div
                                            ...
                                            className="flex flex-col gap-2 text-sm lg:gap-4 lg:text-base"
                                        >
                                            <div className="flex items-center gap-2">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-black/70 dark:text-white/70">laravel.com</span>
                                                </div>
                                            </div>
                                            <div className="text-black dark:text-white">
                                                <span className="font-semibold">Laravel</span>
                                                <span className="text-black/70 dark:text-white/70"> - The PHP Framework for Web Artisans</span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
