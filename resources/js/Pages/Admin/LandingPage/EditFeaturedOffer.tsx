...
interface EditFeaturedOfferProps {
    offer: Offer;
...
const EditFeaturedOffer: React.FC<EditFeaturedOfferProps> = ({ offer, offersTexts, featuredOffersSettings, categories }) => {
    const [imagePreview, setImagePreview] = useState<string | null>(offer.image_path ? `/storage/${offer.image_path}` : null);
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        offers_text_id: offer.offers_text_id || null,
        featured_offers_setting_id: offer.featured_offers_setting_id || null,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        put(route('admin.landing-page.featured-offers.update', offer.id), {
            forceFormData: true
        });
    };
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-2xl font-bold">تعديل العرض المميز</h2>
                                <SecondaryButton
