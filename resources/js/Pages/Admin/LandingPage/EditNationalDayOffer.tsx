...
interface EditNationalDayOfferProps {
    nationalDayOffer: NationalDayOffer;
}

const EditNationalDayOffer: React.FC<EditNationalDayOfferProps> = ({ nationalDayOffer }) => {
    ...
    const { data, setData, post, processing, errors } = useForm({
        title_ar: nationalDayOffer.title_ar,
        description_ar: nationalDayOffer.description_ar,
        button_text_ar: nationalDayOffer.button_text_ar,
        button_url: nationalDayOffer.button_url,
        offer1_title: nationalDayOffer.offer1_title,
        offer1_discount_percentage: nationalDayOffer.offer1_discount_percentage,
        offer1_category_slug: nationalDayOffer.offer1_category_slug,
        offer1_category_name: nationalDayOffer.offer1_category_name,
        offer1_image: null as File | null,
        offer1_link: nationalDayOffer.offer1_link,
        offer2_title: nationalDayOffer.offer2_title,
        offer2_discount_percentage: nationalDayOffer.offer2_discount_percentage,
        offer2_category_slug: nationalDayOffer.offer2_category_slug,
        offer2_category_name: nationalDayOffer.offer2_category_name,
        offer2_image: null as File | null,
        offer2_link: nationalDayOffer.offer2_link,
        is_active: nationalDayOffer.is_active
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('admin.landing-page.national-day-offer.update', nationalDayOffer.id), {
            forceFormData: true
        });
    };
    ...
    return (
        <AdminLayout>
            <Head title="تعديل سكشن عرض اليوم الوطني" />
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="bg-blue-50 p-6 rounded-lg">
                                    ...
                                    <div className="hidden mt-4">
                                        ...
                                        {nationalDayOffer.offer1_image_path && (
                                            <div className="mb-2">
                                                <p className="text-sm text-gray-600 mb-2">الصورة الحالية:</p>
                                                <img 
                                                    src={`/storage/${nationalDayOffer.offer1_image_path}`} 
                                                    alt="الصورة الحالية" 
                                        ...
                                        {offer1ImagePreview && (
                                            <div className="mt-2">
                                                <p className="text-sm text-gray-600 mb-2">معاينة الصورة الجديدة:</p>
                                ...
                                <div className="bg-green-50 p-6 rounded-lg">
                                    ...
                                    <div className="hidden mt-4">
                                        ...
                                        {nationalDayOffer.offer2_image_path && (
                                            <div className="mb-2">
                                                <p className="text-sm text-gray-600 mb-2">الصورة الحالية:</p>
                                                <img 
                                                    src={`/storage/${nationalDayOffer.offer2_image_path}`} 
                                                    alt="الصورة الحالية" 
                                                    className="h-32 w-32 object-cover rounded" 
                                                />
                                            </div>
...
export default EditNationalDayOffer;
