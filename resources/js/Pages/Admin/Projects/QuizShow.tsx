                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2">
                        <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-lg shadow-sm p-6">
                                <h3 className="text-lg font-semibold text-gray-900 mb-4">صور المساحة</h3>
                                {quiz.images && quiz.images.length > 0 ? (
                                    <>
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                            {quiz.images.map((image, index) => (
                                                <div key={index} className="relative group">
                                                    <img
                                                        src={`/storage/${image}`}
                                                        alt={`صورة المساحة ${index + 1}`}
                                    ...
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-gray-500">لم يتم رفع أي صور مع هذا المشروع</p>
                                    </div>
                                )}
                            </div>
                        </div>
