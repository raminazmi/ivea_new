                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex items-center justify-between gap-1 text-xs text-gray-500">
                                                        <span>{article.date} . {article.read_time} دقائق للقراءة</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ))
                                    ...
                                    {categories && categories.length > 0 ? (
                                        categories.map((category) => (
                                            <button
                                                ...
                                                className={`w-fit text-right py-1 px-2 text-xs md:text-sm rounded-lg transition-colors ${selectedCategory === category
                                                    ? 'bg-yellow-400 text-gray-900'
                                                    : 'bg-white text-gray-700 hover:bg-gray-100'
                                                    }`}
                                            >
